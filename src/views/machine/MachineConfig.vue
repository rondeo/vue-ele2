...
<template>
  <div>
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column sortable prop="machineNo" label="终端号">
      </el-table-column>
      <el-table-column sortable prop="payType" label="支付方式">
      </el-table-column>
      <el-table-column sortable prop="configName" label="显示名称">
      </el-table-column>
      <el-table-column sortable prop="payOpen" label="状态">
      </el-table-column>
      <el-table-column sortable prop="editTime" label="修改时间">
        <template slot-scope="scope">
          <div>{{scope.row.editTime|timestampToTime}}</div>
          </el-switch>
        </template>
      </el-table-column>
      <el-table-column sortable prop="editUser" label="修改人">
      </el-table-column>
