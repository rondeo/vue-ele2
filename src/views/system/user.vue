        ...
        <template slot-scope="scope">
          ...
          <el-dropdown size="mini" split-button type="primary">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-button @click="resetpwd(scope.$index, scope.row)">重置密码</el-button>
              <el-button @click="dataAccess(scope.$index, scope.row)">数据权限</el-button>
              <el-button @click="offlineUser(scope.$index, scope.row)">下线</el-button>
              <el-button @click="refreshCache(scope.$index, scope.row)">刷新缓存</el-button>
            </el-dropdown-menu>
          </el-dropdown>
